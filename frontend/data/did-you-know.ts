...
const MATCH_FACTS: Record<string, MatchFact> = {
  // ── June 11 ──────────────────────────────────────────────────────────────
  MEX_RSA: { fact: "Mexico hosted the World Cup in 1970 and 1986. Their 2026 co-hosting makes them the first country ever to host three times.", category: 'record' },

  // ── June 12 ──────────────────────────────────────────────────────────────
  KOR_CZE: { fact: "South Korea are the only Asian team to reach a World Cup semi-final. They knocked out Spain and Italy, two former world champions, along the way in 2002.", category: 'wc-history' },
  CAN_BIH: { fact: "Canada are co-hosts of the 2026 World Cup alongside the USA and Mexico. It's the first time three nations have shared hosting duties in the tournament's 96-year history.", category: 'tournament' },
  ...
  QAT_SUI: { fact: "Switzerland beat eventual champions Spain 1–0 in the 2010 World Cup group stage. It was Spain's only defeat in a tournament they won from start to finish.", category: 'wc-history' },
  ...
  GER_CUW: { fact: "Curaçao is a Caribbean island of about 160,000 people and one of the smallest nations ever to appear at a World Cup.", category: 'trivia' },
  NED_JPN: { fact: "Japan beat Germany and Spain in the same 2022 World Cup group stage, coming from behind in both games. Both were former world champions.", category: 'wc-history' },
  ...
  // ── June 16 ──────────────────────────────────────────────────────────────
  IRN_NZL: { fact: "New Zealand went unbeaten at the 2010 World Cup with three draws, including one against Italy, the reigning world champions. They were still eliminated.", category: 'record' },
  ...
  CZE_RSA: { fact: "South Africa's Siphiwe Tshabalala scored the opening goal of the first World Cup held on African soil in 2010. It remains one of the most celebrated strikes in the competition's history.", category: 'wc-history' },
  SUI_BIH: { fact: "Switzerland have been knocked out of the World Cup on penalties more times than any other nation, with four shootout exits in total. They get there and then they can't finish it.", category: 'record' },
  ...
  NOR_SEN: { fact: "Senegal's 2002 squad did most of their football in France's lower leagues and still beat the defending world champions in their opening World Cup game.", category: 'wc-history' },
  ...
  // ── June 27 ──────────────────────────────────────────────────────────────
  URU_ESP: { fact: "Spain won three consecutive major tournaments, Euro 2008, World Cup 2010, and Euro 2012, making them the only nation ever to win three in a row. Uruguay won the very first World Cup in 1930.", category: 'record' },
...
export const FALLBACK_FACTS: string[] = [
  ...
  "Brazil have played at every World Cup in history, all 23 of them. No other nation even comes close.",
  "Just Fontaine scored 13 goals at the 1958 World Cup, a record that has stood for over 65 years.",
  "Miroslav Klose holds the all-time World Cup scoring record with 16 goals across four tournaments for Germany.",
